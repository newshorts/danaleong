			<footer class="row footer">
				...
				<div class="row social">
					<div class="columns large-3 large-centered large-text-center">
						<a href="http://www.facebook.com/sharer/sharer.php?u=http://www.danaleung.com" class="social-icon facebook"></a>
						<a href="https://twitter.com/intent/tweet?text=Sample%20text%20and%20stuff&url=http%3A%2F%2Fdanaleung.com%2F&hashtags=danaleung" class="social-icon twitter"></a>
						<a href="https://www.instagram.com/danaleung/" class="social-icon instagram"></a>
					</div>
				</div>

				<div class="large-centered large-text-center">
					<p>DANALEONG.COM &copy; <span class="copyright-year">2016</span></p>
				</div>
			</footer>
